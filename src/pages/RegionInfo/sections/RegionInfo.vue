    ...
    <div class="grid md:grid-cols-2 gap-y-10 pb-10">
      <div class="text-left px-4 flex flex-col space-y-1">
        ...
        <div class="leading-8 tracking-wider">
          ...
          <p class="pt-1">
            Biome:
            <span class="font-semibold">{{ biome }}</span>
          </p>
      ...
      <div class="text-left px-4 flex flex-col space-y-1">
        ...
        <div class="leading-8 tracking-wider">
          <p class="">
            Tax Rate: <span class="font-semibold">{{ taxRate }}%</span>
          </p>
...
export default {
  ...
  computed: {
    ...
    development() {
      return this.regionInfo.development
        ? this.regionInfo.development.developmentName
        : "";
    },
    developmentLevel() {
      return this.regionInfo.development
        ? this.regionInfo.development.developmentId
        : "";
    },
    growthModifier() {
      return this.regionInfo.development
        ? this.regionInfo.development.growthModifier
        : "";
    },
    shrinkageModifier() {
      return this.regionInfo.development
        ? this.regionInfo.development.shrinkageModifier
        : "";
    },
    facilityCount() {
      return 1;
    ...
    corruption() {
      return this.regionInfo.corruption
        ? this.regionInfo.corruption.corruptionName
        : "";
    },
    corruptionLevel() {
      return this.regionInfo.corruption
        ? this.regionInfo.corruption.corruptionId
        : "";
    },
    corruptionRate() {
      return this.regionInfo.corruption
        ? this.regionInfo.corruption.corruptionRate
        : "";
    },
  },
};
