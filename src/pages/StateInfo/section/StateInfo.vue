  ...
  <div class="mt-4 flex flex-col space-y-2 max-w-3xl mx-auto my-1 mb-4">
    ...
    <div class="grid grid-cols-2 gap-y-10">
        ...
        <div class="leading-8 tracking-wider">
          <p class="pt-1">
            ...
            <span class="font-semibold"
              >{{ treasury ? treasury.toFixed(2) : "" }}G</span
            >
          </p>
          <p class=" ">
            Total Income:<span class="font-semibold">
              {{ totalIncome ? totalIncome.toFixed(2) : "" }}G</span
            >
          </p>
          <p class="">
            Next Season Income:<span class="font-semibold"
              >{{ nextIncome ? nextIncome.toFixed(2) : "" }}G</span
            >
          </p>
          <p class="pt-1">
            Administration Cost:<span class="font-semibold"
              >{{ adminCost ? adminCost.toFixed(2) : "" }}G</span
            >
          </p>
          <p class="">
            Admin Cost Modifier:<span class="font-semibold">
              {{ adminCostModifier }}%</span
            >
          </p>
          <p class="">
            Military, Diplomatic & Misc. Expenses:
            <span class="font-semibold"
              >{{ expenses ? expenses.toFixed(2) : "" }}G</span
            >
          </p>
          <p class="">
            Total Expenses:<span class="font-semibold">
              {{ totalExpenses ? totalExpenses.toFixed(2) : "" }}G</span
            >
          </p>
        </div>
      </div>
      <div class="text-left px-4 flex flex-col space-y-1">
        ...
        <div class="leading-8 tracking-wider">
          <p class="pt-1">
            Total Population:<span class="font-semibold">
              {{ population }} Pop</span
            >
          </p>
          <p class="pt-1">
            Average Dev Level:<span class="font-semibold"
              >Level {{ averageDevLevel }}</span
            >
          </p>
          <p class="pt-1">
            Facility Count:<span class="font-semibold"
              >{{ facilityCount }} Facilities</span
            >
          </p>
        </div>
      </div>
