  ...
  try {
    ...
    for (let i = 0; i < initialState.length; i++) {
      ...
      if (Array.isArray(stateResources) && stateResources.length) {
        ...
        sheet.getCell("A" + lastRowNum).font = {
          name: "Calibri",
          size: 14,
          bold: true,
        };
        sheet.getCell("A" + lastRowNum).alignment = {
          vertical: "middle",
          horizontal: "center",
        };
      ...
      tradeAgreements.map((agreement) => {
        ...
        if (traderIdx > -1) {
          stateTradeAgreements.push({
            ...
            tradePower:
              parseFloat(agreement.traders[traderIdx].tradePower * 100).toFixed(
                2
              ) + "%",
      ...
      if (Array.isArray(stateTradeAgreements) && stateTradeAgreements.length) {
        ...
        sheet.getCell("G" + lastRowNum).font = {
          name: "Calibri",
          size: 14,
          bold: true,
        };
        sheet.getCell("G" + lastRowNum).alignment = {
          vertical: "middle",
          horizontal: "center",
        };
